...
export function StudentTopBar({
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[29rem] items-center justify-between gap-3 xl:max-w-[29rem]">
        <div className="pointer-events-auto flex min-w-0 max-w-[58vw] items-center rounded-[1.2rem] border border-white/10 bg-card/78 px-3.5 py-2.5 shadow-[0_18px_40px_rgba(0,0,0,0.26)] backdrop-blur-2xl">
          <NxtdriveLogo
