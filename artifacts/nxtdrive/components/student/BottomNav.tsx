...
export function StudentBottomNav() {
  ...
  return (
    ...
    >
      <ul className="pointer-events-auto mx-auto grid max-w-[430px] grid-cols-5 rounded-[1.45rem] border border-brand-border/80 bg-white/94 p-1.5 shadow-brand-card backdrop-blur-2xl">
