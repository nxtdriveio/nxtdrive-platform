        ...
        {shortcuts.map((shortcut) => {
          ...
          return (
            <Link
              ...
              href={shortcut.href}
              className={cn(
                "group relative min-w-0 overflow-hidden rounded-[1.45rem] border border-white/10 bg-[linear-gradient(180deg,rgba(20,20,36,0.98),rgba(11,11,23,0.98))] px-3 py-4 shadow-[0_18px_40px_rgba(1,2,8,0.32)] transition hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-[0_22px_45px_color-mix(in_oklab,var(--primary)_28%,transparent)]",
              )}
            >
              ...
              <div className="relative flex h-full min-h-[8.1rem] flex-col items-start justify-between gap-3 text-left sm:min-h-[8.85rem]">
                ...
                <div className="space-y-1">
                  <span className="block text-base font-semibold text-white sm:text-[1.08rem]">{shortcut.label}</span>
