...
export function InstructorTopbar({
  ...
  return (
    <header className="instructor-topbar-desktop sticky top-0 z-20 h-16 shrink-0 items-center gap-3 border-b border-brand-border/80 bg-white/86 px-4 backdrop-blur-xl xl:px-6">
