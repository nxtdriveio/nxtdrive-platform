...
export function InstructorSidebar({
  ...
  return (
    <>
      <aside className="instructor-sidebar-desktop sticky top-0 h-screen w-[18.5rem] shrink-0 overflow-hidden bg-brand-sidebar-background text-brand-sidebar-foreground shadow-[28px_0_80px_rgba(10,20,44,0.18)]">
      ...
      <header
        className="instructor-mobile-header sticky top-0 z-30 border-b border-brand-border/80 bg-white/88 backdrop-blur-xl"
      ...
      <nav
        ...
        className="instructor-mobile-nav pointer-events-none fixed inset-x-0 bottom-0 z-30 px-3"
