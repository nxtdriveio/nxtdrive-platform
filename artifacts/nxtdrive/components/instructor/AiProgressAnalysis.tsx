    ...
    <Card>
      <CardContent className="space-y-4 pt-5">
        ...
        <p className="text-xs text-muted-foreground">
          Adviserende analyse van zwakke onderdelen, slagingskans en focus voor
          komende lessen — op basis van de leskaartcijfers en de examenrijpheid.
        </p>
          ...
          <div className="space-y-4">
            <section className="space-y-1.5 rounded-lg border border-border bg-muted/40 p-3">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  variant={KANS_VARIANT[analysis.slagingskans.indicatie] ?? "warning"}
                >
        ...
        <p className="flex gap-1.5 text-xs text-muted-foreground">
          ...
          AI-gegenereerd advies. Niet bindend — de instructeur bepaalt de planning
          en het examenmoment.
        </p>
      </CardContent>
    </Card>
