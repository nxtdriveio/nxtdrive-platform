...
export const COMMON_SHORTCODES: ShortcodeDef[] = [
  { code: "tenant_name", label: "Rijschoolnaam", example: "NXTDRIVE Demo Academy" },
];
...
const CATALOG: Partial<Record<NotificationType, ShortcodeDef[]>> = {
  payment_confirmation: [
    ...
    { code: "paid_at",       label: "Betaaldatum/-tijd",example: "di 3 jun 2026 14:22" },
  ],

  lesson_reminder: [
    { code: "student_name",   label: "Naam leerling",   example: "Jan de Vries" },
    { code: "lesson_time",    label: "Tijdstip les",    example: "wo 10 jun 2026 14:00" },
    { code: "location",       label: "Locatie",         example: "Stationsplein 1, Utrecht" },
    { code: "instructor_name",label: "Instructeursnaam",example: "Sofie Bakker" },
  ],
  ...
  task_assigned: [
    ...
    { code: "task_url",       label: "URL naar taak",   example: "https://app.nxtdrive.io/backoffice/taken" },
  ],

  trial_lesson_received: [
    { code: "lead_name",   label: "Naam prospect",   example: "Lotte Smit" },
    { code: "lesson_time", label: "Gewenste tijd",   example: "za 14 jun 2026 10:00" },
    { code: "location",    label: "Voorkeurslocatie",example: "Utrecht centrum" },
  ],

  trial_lesson_confirmed: [
    { code: "lead_name",      label: "Naam prospect",   example: "Lotte Smit" },
    { code: "lesson_time",    label: "Tijdstip proefles",example: "za 14 jun 2026 10:00" },
    { code: "location",       label: "Locatie",          example: "Stationsplein 1, Utrecht" },
    { code: "instructor_name",label: "Instructeursnaam", example: "Sofie Bakker" },
  ],
  ...
  lesson_refill_invitation: [
    { code: "student_name",   label: "Naam leerling",    example: "Jan de Vries" },
    { code: "lesson_time",    label: "Vrijgekomen moment",example: "ma 9 jun 2026 09:00" },
    { code: "location",       label: "Locatie",           example: "Stationsplein 1, Utrecht" },
    { code: "instructor_name",label: "Instructeursnaam",  example: "Sofie Bakker" },
    { code: "expires_at",     label: "Vervaldatum uitnodiging",example: "ma 9 jun 2026 18:00" },
  ],

  lesson_refill_confirmed: [
    { code: "student_name",   label: "Naam leerling",   example: "Jan de Vries" },
    { code: "lesson_time",    label: "Tijdstip les",    example: "ma 9 jun 2026 09:00" },
    { code: "location",       label: "Locatie",         example: "Stationsplein 1, Utrecht" },
    { code: "instructor_name",label: "Instructeursnaam",example: "Sofie Bakker" },
  ],
  ...
  exam_invitation: [
    ...
    { code: "instructor_name",label: "Instructeursnaam",example: "Sofie Bakker" },
    { code: "expires_at",     label: "Vervaldatum uitnodiging",example: "ma 16 jun 2026 18:00" },
  ],
  ...
  review_request: [
    { code: "student_name",     label: "Naam leerling",   example: "Jan de Vries" },
    { code: "google_review_url",label: "Google review-URL",example: "https://g.page/r/xxxxx/review" },
  ],
  ...
  lesson_rescheduled: [
    { code: "student_name",         label: "Naam leerling",   example: "Jan de Vries" },
    { code: "previous_lesson_time", label: "Oud tijdstip",    example: "wo 10 jun 2026 14:00" },
    { code: "new_lesson_time",      label: "Nieuw tijdstip",  example: "vr 12 jun 2026 10:00" },
    { code: "location",             label: "Locatie",         example: "Stationsplein 1, Utrecht" },
    { code: "instructor_name",      label: "Instructeursnaam",example: "Sofie Bakker" },
  ],

  lesson_rescheduled_instructor: [
    { code: "instructor_name",      label: "Naam instructeur", example: "Sofie Bakker" },
    { code: "student_name",         label: "Naam leerling",    example: "Jan de Vries" },
    { code: "previous_lesson_time", label: "Oud tijdstip",     example: "wo 10 jun 2026 14:00" },
    { code: "new_lesson_time",      label: "Nieuw tijdstip",   example: "vr 12 jun 2026 10:00" },
    { code: "location",             label: "Locatie",          example: "Stationsplein 1, Utrecht" },
