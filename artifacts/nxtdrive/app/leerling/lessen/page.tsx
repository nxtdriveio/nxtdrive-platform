...
export default async function StudentLessonsPage({
  ...
  const tabs = [
    { key: "lessons", label: "Lessen", href: "/leerling/lessen?tab=lessons", count: upcoming.length },
    {
      key: "exams",
      label: "Examens",
      href: "/leerling/lessen?tab=exams",
      count: examAppointments.length,
    },
    {
      key: "planning",
      label: "Planning",
      href: `/leerling/lessen?tab=planning&date=${selectedKey}`,
    },
      ...
      {activeTab === "lessons" ? (
        <div className="space-y-4">
          <StudentShowcaseCard
            ...
            actionHref="/leerling/lessen/boeken"
          >
            {upcoming.length === 0 ? (
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-3">
                <a
                  href={`/leerling/lessen?tab=planning&date=${adjacentMonthYmd(
                    selectedKey,
                    -1,
                  )}`}
              ...
              <div className="grid grid-cols-7 gap-2">
                {monthDates.map((key) => {
                  ...
                  return (
                    <a
                      key={key}
                      href={`/leerling/lessen?tab=planning&date=${key}`}
                      className={[
