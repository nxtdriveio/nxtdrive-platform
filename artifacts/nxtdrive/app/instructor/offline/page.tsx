 ...
 * worker and served when a navigation fails offline. Branded, no data fetching.
 */
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center gap-6 text-center">
      <div className="flex flex-col items-center gap-4 rounded-3xl bg-gradient-to-b from-slate-800 to-slate-950 px-8 py-10 text-white shadow-xl">
        ...
        <h1 className="text-xl font-semibold">NXTDRIVE Instructeur</h1>
        <p className="max-w-md text-sm text-white/70">
          De verbinding is even weg. Je dagplanning verschijnt automatisch weer
          zodra je internet terug is.
        </p>
        <button
          type="button"
